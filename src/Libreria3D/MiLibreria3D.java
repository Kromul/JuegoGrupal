...
public class MiLibreria3D {
	...
	public static BranchGroup escalarEstatico(BranchGroup objRoot, float escala) {
        ...
        /**
         * Este metodo añade el sonido a una rama de ejecucion del arbol
         * haciendo uso de dos metodos auxiliares que hay mas abajo
         * llamados configurarUniverso y anadirSonidoARama
         * @param universo
         * @param rootBG
         * @param ruta 
         */
